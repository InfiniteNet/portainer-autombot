...
```
sudo apt update && sudo apt install -y git && git clone https://github.com/InfiniteNet/portainer-autombot.git && cd portainer-packtypebot && sudo chmod +x install.sh && ./install.sh
```
